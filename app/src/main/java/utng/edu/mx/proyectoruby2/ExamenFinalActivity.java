...
public class ExamenFinalActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initComponents() {
        ...
        switch (valorResividos.getInt("numeroExamne")){
            case 1:
                txvPreguntaUno.setText(getResources().getString(R.string.examen_final_uno_pregunta_uno));
                rbtOpcionUno.setText(getResources().getString(R.string.examen_final_uno_pregunta_uno_respuesta_uno));
                rbtOpcionDos.setText(getResources().getString(R.string.examen_final_uno_pregunta_uno_respuesta_dos));

                txvPreguntaDos.setText(getResources().getString(R.string.examen_final_uno_pregunta_dos));
                chkUno.setText(getResources().getString(R.string.examen_final_uno_pregunta_dos_respuesta_uno));
                chkDos.setText(getResources().getString(R.string.examen_final_uno_pregunta_dos_respuesta_dos));
                chkTres.setText(getResources().getString(R.string.examen_final_uno_pregunta_dos_respuesta_tres));

                txvPreguntaTres.setText(getResources().getString(R.string.examen_final_uno_pregunta_tres) );
                txvParteUno.setText(getResources().getString(R.string.examen_final_uno_pregunta_tres_respuesta_uno));
                //edtParteDos
                txvParteTres.setText(getResources().getString(R.string.examen_final_uno_pregunta_tres_respuesta_uno));
    ...
    public void onClick(View v) {
        ...
        switch (valorResividos.getInt("numeroExamne")){
            ...
            case 5:
                ...
                timer.cancel();
                timer.onFinish();
                startActivity(new Intent(ExamenFinalActivity.this,EmailActivity.class));
                break;
            default:
