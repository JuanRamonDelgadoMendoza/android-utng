...
public class SeleccionModuloActivity extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    private Bundle bundle,valoresRecibidosLogin;
    ...
    private void initComponents(){
        ...
        if (dbAdapter.terminoApp(FormLoginActivity.ID_USU_LOGEADO)){
            ...
            btnCorreo.setText(getResources().getString(R.string.boton_termino_curso_email));
            btnGrafica.setText(getResources().getString(R.string.boton_termino_curso_grafica));
            ...
            btnCorreo.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    startActivity(new Intent(SeleccionModuloActivity.this, EmailActivity.class));
                }
            });
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {//falta colocar en caso de que de clic en examen final
        ...
        if (valoresRecibidosLogin.getBoolean("logeo")){
            ...
            switch (position){
                ...
                case 4:///--------------------------------------------------------------------------Examen Fianl 1
                    ...
                    if (activo) {
                        ...
                        MensajeError(getResources().getString(R.string.texto_mensaje_bloqueo_examen_logeado),
                                getResources().getString(R.string.titulo_mensaje_bloqueo_examen));
                    }
                    break;
            }
            if (pasarSiguiente!=0){
            ...
            if (pasarErro!=0){
                MensajeError(getResources().getString(R.string.texto_mensaje_bloqueo_modulo_logeado),
                        getResources().getString(R.string.titulo_mensaje_bloqueo_modulo));
                pasarErro=0;
            }
            ...
            if (position==0){
                ...
                MensajeError(getResources().getString(R.string.texto_mensaje_bloqueo_examen),
                        getResources().getString(R.string.titulo_mensaje_bloqueo_examen));
            }else {
                MensajeError(getResources().getString(R.string.texto_mensaje_bloqueo_modulo),
                        getResources().getString(R.string.titulo_mensaje_bloqueo_modulo));
            }
        }
    }
        ...
        if (valoresRecibidosLogin.getBoolean("logeo")){
            switch (item.getItemId()) {
                ...
                case R.id.itm_actionbar_menu_salir_on:
                    ...
                    itmSalir();
                    break;
                case R.id.itm_actionbar_menu_crucigrama:
                    startActivity(new Intent(SeleccionModuloActivity.this,CrucigramaActivity.class));
                    break;
                case R.id.itm_actionbar_menu_juego:
                    //Ayuda y sugerencias
                    startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(getResources().getString(R.string.url_consola_online))));
