...
public class SeleccionTemaActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    private Bundle valoresRecibidos, bundle;
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (valoresRecibidos.getBoolean("logeo")) {
                    ...
                    switch (position){
                        ...
                        case 7://-------------------------------------------------------------------Exam
                            ...
                            if (activo) {
                                ...
                                MensajeError(getResources().getString(R.string.texto_mensaje_bloqueo_examen_logeado_dos),
            ...
            if (pasarErr!=0){
                MensajeError(getResources().getString(R.string.texto_mensaje_bloqueo_tema_logeado),
                        getResources().getString(R.string.titulo_mensaje_bloqueo_tema_logeado));
                pasarErr=0;
            }
        }else {
            if (position==0){
                ...
                MensajeError(getResources().getString(R.string.texto_mensaje_bloqueo_tema_),
                        getResources().getString(R.string.titulo_mensaje_bloqueo_tema_logeado));
            }
        }
    }
        ...
        if (valoresRecibidos.getBoolean("logeo")){
            switch (item.getItemId()) {
                ...
                case R.id.itm_actionbar_menu_crucigrama:
                    startActivity(new Intent(SeleccionTemaActivity.this, CrucigramaActivity.class));
                    break;
